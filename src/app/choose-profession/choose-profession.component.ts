...
@Component({
  ...
  styleUrls: ['./choose-profession.component.scss', '../cards/cards.component.scss']
})
export class ChooseProfessionComponent {
  ...
  getRandomProfessions(): void {
    ...
    let start1 = getRandomIndex(1,21);
    let end1 = start1 + 1;
    console.log(start1)
    console.log(end1)
    let start2 = getRandomIndex(1,21);
    let end2 = start2 + 1;
    console.log(start2)
    console.log(end2)
    while (start1 == start2) {
      start2 = getRandomIndex(1,21);
      end2 = start2 + 1;
    }
    console.log(start2)
    console.log(end2)
